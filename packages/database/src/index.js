            ...
            client: {
                async create({ args, query }) {
                    ...
                    if (args.data.city && args.data.organizationId) {
                        const orgId = typeof args.data.organizationId === 'string' ? args.data.organizationId : args.data.organizationId?.connect?.id;
                        if (orgId) {
                ...
                async update({ args, query }) {
                    const newState = args.data.lifecycleState;
                    if (newState) {
                        // Fetch current state
