...
async function seed() {
    ...
    const gbpData = [
        {
            ...
            secondaryCategories: '["House Cleaning","Commercial Cleaning","Move-In/Out Cleaning"]',
            description: "Professional cleaning services for homes and businesses. Trusted by 500+ customers in Dallas-Fort Worth area.",
        ...
        },
        {
            ...
            secondaryCategories: '["Drain Cleaning","Water Heater Repair","Emergency Plumbing"]',
            description: "Licensed & insured plumbers available 24/7. Austin\'s most trusted plumbing service since 2015.",
        ...
        },
        {
            ...
            primaryCategory: "Gym",
            secondaryCategories: '["Personal Trainer","Fitness Center","Weight Training"]',
            description: "Denver\'s premier personal training gym. Custom programs, expert coaches, real results.",
        ...
        },
        {
            ...
            description: "Fresh seafood sourced daily. Waterfront dining with the best ocean views in San Diego.",
        ...
        },
        {
            ...
            secondaryCategories: '["Animal Hospital","Pet Store","Emergency Veterinary Service"]',
            description: "Full-service veterinary care for dogs, cats, and exotic pets. Compassionate care you can trust.",
        ...
        },
        {
            ...
            description: "Premium auto detailing with ceramic coating protection. We make your car look brand new.",
    ...
    const reviewData = [
        {
            ...
            rating: 5,
            content: "Amazing cleaning service! They made my house spotless in just 3 hours. Highly recommend.",
        ...
        },
        {
            ...
            rating: 5,
            content: "Best cleaning company in Dallas! We use them monthly for our office.",
        ...
        },
        {
            ...
            rating: 5,
            content: "Saved us from a flooded basement on a Saturday night. Lifesavers!",
        ...
        },
        {
            ...
            rating: 5,
            content: "Incredible transformation in 12 weeks. My coach Jake is the best!",
        ...
        },
        {
            ...
            rating: 4,
            content: "Great facility and friendly staff. Would love more group classes.",
        ...
        },
        {
            ...
            rating: 1,
            content: "Waited 45 minutes for our table. Food was cold when it arrived. Never again.",
            reviewDate: DAYS_AGO(1),
        },
    ];
    ...
    const compData = [
        {
            ...
            strengths: '{"brand_recognition": "Strong national brand", "review_volume": "High review count"}',
            weaknesses: '{"personalization": "Generic service descriptions", "response_time": "Slow review replies"}',
        },
        {
            clientId: clients[0].id,
            ...
            strengths: '{"photos": "High quality photos", "posts": "Consistent posting"}',
            weaknesses: '{"categories": "Only 2 categories", "service_list": "Limited services listed"}',
        },
        {
            clientId: clients[1].id,
            ...
            strengths: '{"reviews": "Very high review count", "brand": "National brand recognition"}',
            weaknesses: '{"rating": "Below 4.5 average", "engagement": "Low review reply rate"}',
        },
    ];
    ...
    const taskData = [
        {
            ...
            description: "Build comprehensive parent/child service taxonomy for SparkleClean GBP profile",
            module: "M1",
            sprint: 3,
        ...
        },
        {
            ...
            description: "Pull keyword volume/difficulty data for primary and secondary keywords using DataForSEO API",
            module: "M1",
            sprint: 3,
            priority: TaskPriority.HIGH,
            status: TaskStatus.DONE,
        ...
        },
        {
            ...
            description: "Run competitor teardown across 3+ geo-points and 5+ keywords using DataForSEO",
            module: "M1",
            sprint: 3,
            priority: TaskPriority.HIGH,
            status: TaskStatus.DONE,
        ...
        },
        {
            ...
            description: "Configure 3 service areas with correct radius for SAB profile",
            module: "M1",
            sprint: 3,
        ...
        },
        {
            ...
            description: "Write 750-char description with banned-content linter compliance check",
            module: "M1",
            sprint: 3,
            priority: TaskPriority.MEDIUM,
        ...
        },
        {
            ...
            description: "Upload exterior/interior photos and verify count meets competitor avg × 1.25",
            module: "M1",
            sprint: 3,
            priority: TaskPriority.MEDIUM,
        ...
        },
        {
            ...
            description: "Execute state machine transition from BUILD to GROWTH after all Phase 0-2 tasks complete",
            module: "M6",
            sprint: 1,
            priority: TaskPriority.HIGH,
            status: TaskStatus.DONE,
        ...
        },
        {
            ...
            description: "Complete intake questionnaire and create Client + GbpProfile draft",
            module: "M1",
            sprint: 2,
        ...
        },
        {
            ...
            description: "Capture immutable baseline snapshot of all KPIs for SparkleClean",
            module: "M5",
            sprint: 5,
            priority: TaskPriority.HIGH,
            status: TaskStatus.NOT_STARTED,
        ...
        },
        {
            ...
            description: "System task: process weekly recurring tasks and generate status summary",
            module: "M6",
            sprint: 1,
            priority: TaskPriority.MEDIUM,
            status: TaskStatus.DONE,
        ...
        },
        {
            ...
            description: "Run full citation audit and classify findings by tier. BLOCKED: BrightLocal Grow subscription required.",
            module: "M3",
            sprint: 7,
            priority: TaskPriority.MEDIUM,
        ...
        // ─── Luxe Auto Detailing (GROWTH, clients[7]) ───
        {
            ...
            description: "Create 4 weekly GBP posts for Luxe Auto Detailing covering before/after showcases, seasonal tips, and ceramic coating education",
            module: "M1",
            sprint: 4,
            priority: TaskPriority.MEDIUM,
            status: TaskStatus.IN_PROGRESS,
        ...
        },
        {
            ...
            description: "Develop personalized review response templates for Luxe Auto Detailing and respond to 5 most recent reviews",
            module: "M1",
            sprint: 4,
            priority: TaskPriority.HIGH,
            status: TaskStatus.NOT_STARTED,
        ...
        },
        {
            ...
            description: "Audit and fix Name, Address, Phone inconsistencies across 50+ directories for Luxe Auto Detailing in Phoenix metro",
            module: "M3",
            sprint: 7,
            priority: TaskPriority.HIGH,
            status: TaskStatus.NOT_STARTED,
        ...
        // ─── Paws & Claws Vet (BUILD, clients[6]) ───
        {
            ...
            description: "Review and optimize primary/secondary categories for Paws & Claws Vet — ensure 'Veterinarian' is primary, add 'Emergency Veterinary Service'",
            module: "M1",
            sprint: 3,
            priority: TaskPriority.HIGH,
            status: TaskStatus.NOT_STARTED,
        ...
        },
        {
            ...
            description: "Audit Paws & Claws website contact page for NAP consistency, schema markup, and CTA alignment with GBP profile",
            module: "M2",
            sprint: 5,
            priority: TaskPriority.MEDIUM,
            status: TaskStatus.NOT_STARTED,
        ...
        },
        {
            ...
            description: "Set up Q&A monitoring for Paws & Claws Vet GBP profile, draft responses for 3 common veterinary questions",
            module: "M1",
            sprint: 4,
            priority: TaskPriority.MEDIUM,
            status: TaskStatus.NOT_STARTED,
        ...
        // ─── TechRepair Hub (PAUSED, clients[5]) ───
        {
            ...
            description: "Contact TechRepair Hub owner to assess re-engagement readiness, review reasons for pause, and prepare reactivation plan",
            module: "M6",
            sprint: 1,
            priority: TaskPriority.MEDIUM,
            status: TaskStatus.NOT_STARTED,
        ...
        },
        {
            ...
            description: "Draft and submit GBP suspension appeal for TechRepair Hub with supporting business documentation",
            module: "M1",
            sprint: 5,
            priority: TaskPriority.HIGH,
            status: TaskStatus.BLOCKED,
        ...
        // ─── Coastal Bites Restaurant (AT_RISK, clients[4]) ───
        {
            ...
            description: "Analyze last 90 days of reviews for Coastal Bites to identify negative sentiment patterns and root causes of 1-star ratings",
            module: "M1",
            sprint: 4,
            priority: TaskPriority.HIGH,
            status: TaskStatus.IN_PROGRESS,
        ...
        },
        {
            ...
            description: "Run competitor gap analysis for Coastal Bites vs top 5 seafood restaurants in San Diego map pack",
            module: "M1",
            sprint: 3,
            priority: TaskPriority.HIGH,
            status: TaskStatus.NOT_STARTED,
        ...
        },
        {
            ...
            description: "Create comprehensive recovery action plan addressing suspension, review score decline, and competitor gaps for Coastal Bites",
            module: "M6",
            sprint: 1,
            priority: TaskPriority.CRITICAL,
            status: TaskStatus.NOT_STARTED,
        ...
        // ─── Round 11: Additional 20 tasks across ALL clients ───
        {
            ...
            description: "Collect and verify Bloom Garden Design business license, insurance docs, and tax ID for GBP claim",
            module: "M1",
            sprint: 2,
            priority: TaskPriority.CRITICAL,
            status: TaskStatus.NOT_STARTED,
        ...
        },
        {
            ...
            description: "Audit Bloom Garden website for SEO fundamentals, add LocalBusiness schema markup",
            module: "M2",
            sprint: 5,
            priority: TaskPriority.MEDIUM,
            status: TaskStatus.NOT_STARTED,
        ...
        },
        {
            ...
            description: "Capture baseline KPIs for Bloom Garden including search impressions, website traffic, and lead volume",
            module: "M5",
            sprint: 5,
            priority: TaskPriority.HIGH,
            status: TaskStatus.NOT_STARTED,
        ...
        },
        {
            ...
            description: "Define primary service area radius and GBP category hierarchy for landscaping business",
            module: "M1",
            sprint: 2,
            priority: TaskPriority.HIGH,
            status: TaskStatus.NOT_STARTED,
        ...
        },
        {
            ...
            description: "Coordinate photo shoot for PeakFit Gym — equipment, classes, trainers, facility exterior/interior",
            module: "M1",
            sprint: 4,
            priority: TaskPriority.HIGH,
            status: TaskStatus.NOT_STARTED,
        ...
        },
        {
            ...
            description: "Create/update citations on Yelp, YellowPages, BBB, Angi, and Thumbtack for PeakFit Gym Denver",
            module: "M3",
            sprint: 7,
            priority: TaskPriority.MEDIUM,
            status: TaskStatus.NOT_STARTED,
        ...
        },
        {
            ...
            description: "Generate and send July performance report for PeakFit with keyword rankings, leads, and recommendations",
            module: "M5",
            sprint: 6,
            priority: TaskPriority.MEDIUM,
            status: TaskStatus.NOT_STARTED,
        ...
        },
        {
            ...
            description: "Verify QuickFix GBP is properly verified and all data is consistent across Google platforms",
            module: "M1",
            sprint: 2,
            priority: TaskPriority.HIGH,
            status: TaskStatus.DONE,
        ...
        },
        {
            ...
            clientId: clients[1].id,
            title: "GA4 & GSC setup",
            description: "Set up Google Analytics 4 and Google Search Console tracking for QuickFix Plumbing website",
            module: "M2",
            sprint: 5,
            priority: TaskPriority.HIGH,
            status: TaskStatus.NOT_STARTED,
        ...
        },
        {
            ...
            description: "Initialize keyword rank tracking for 12 target keywords in Austin plumbing market",
            module: "M5",
            sprint: 5,
            priority: TaskPriority.MEDIUM,
            status: TaskStatus.NOT_STARTED,
        ...
        },
        {
            ...
            description: "Document detailed pause reasons and create reactivation checklist for TechRepair Hub",
            module: "M6",
            sprint: 1,
            priority: TaskPriority.LOW,
            status: TaskStatus.NOT_STARTED,
        ...
        },
        {
            ...
            description: "Clean up stale data, old Q&A, and outdated GBP info before TechRepair re-engagement",
            module: "M1",
            sprint: 5,
            priority: TaskPriority.MEDIUM,
            status: TaskStatus.NOT_STARTED,
        ...
        },
        {
            ...
            description: "Draft professional, empathetic responses to the 3 most critical 1-star reviews for Coastal Bites",
            module: "M1",
            sprint: 4,
            priority: TaskPriority.CRITICAL,
            status: TaskStatus.IN_PROGRESS,
        ...
        },
        {
            ...
            description: "Investigate 40% traffic drop for Coastal Bites website — check GSC, manual actions, and competitor changes",
            module: "M5",
            sprint: 6,
            priority: TaskPriority.HIGH,
            status: TaskStatus.NOT_STARTED,
        ...
        },
        {
            ...
            description: "Set up WhatsApp + email review ask flow for Paws & Claws recent clients",
            module: "M1",
            sprint: 4,
            priority: TaskPriority.HIGH,
            status: TaskStatus.NOT_STARTED,
        ...
        },
        {
            ...
            description: "Audit NAP (Name, Address, Phone) consistency across top 30 citation directories for Paws & Claws Portland",
            module: "M3",
            sprint: 7,
            priority: TaskPriority.MEDIUM,
            status: TaskStatus.NOT_STARTED,
        ...
        },
        {
            ...
            description: "Create 10 FAQ entries for Luxe Auto Detailing GBP covering ceramic coating, pricing, and process questions",
            module: "M1",
            sprint: 4,
            priority: TaskPriority.MEDIUM,
            status: TaskStatus.NOT_STARTED,
        ...
        },
        {
            ...
            description: "Audit and optimize Luxe Auto website for Core Web Vitals — target LCP < 2.5s, CLS < 0.1",
            module: "M2",
            sprint: 5,
            priority: TaskPriority.MEDIUM,
            status: TaskStatus.NOT_STARTED,
        ...
        },
        {
            ...
            description: "Build citations on 25+ Tier 2 directories (Manta, Hotfrog, Foursquare, etc.) for SparkleClean Dallas",
            module: "M3",
            sprint: 7,
            priority: TaskPriority.MEDIUM,
            status: TaskStatus.NOT_STARTED,
        ...
        },
        {
            ...
            description: "Configure 5 anomaly detection rules for SparkleClean — ranking drops, traffic spikes, review velocity, citation changes",
            module: "M5",
            sprint: 6,
            priority: TaskPriority.HIGH,
            status: TaskStatus.NOT_STARTED,
    ...
    const logEntries = [
        {
            taskId: allTasks.find((t) => t.taskId === "M1-5.1" && t.clientId === clients[0].id)?.id,
            level: "INFO",
        ...
        },
        {
            taskId: allTasks.find((t) => t.taskId === "M1-5.1" && t.clientId === clients[0].id)?.id,
            level: "WARN",
            message: "Banned content check: found phone number in draft description — removing",
        },
        {
            taskId: allTasks.find((t) => t.taskId === "M1-5.1" && t.clientId === clients[0].id)?.id,
            level: "INFO",
        ...
        {
            taskId: allTasks.find((t) => t.taskId === "M1-1.1" && t.clientId === clients[1].id)?.id,
            level: "INFO",
        ...
        },
        {
            taskId: allTasks.find((t) => t.taskId === "M1-1.1" && t.clientId === clients[1].id)?.id,
            level: "INFO",
            message: "Identified 8 parent categories and 23 sub-services from DataForSEO data",
        },
        {
            taskId: allTasks.find((t) => t.taskId === "M1-5.1" && t.clientId === clients[3].id)?.id,
            level: "ERROR",
    ...
    const approvalData = [
        ...
        {
            clientId: clients[1].id,
            taskId: allTasks.find((t) => t.taskId === "M1-2.1" && t.clientId === clients[1].id)?.id,
            title: "Keyword Research Results — QuickFix Plumbing",
            description: "Keyword research for Austin plumbing market completed. 12 target keywords identified with volume/difficulty data. Ready to populate KeywordMap.",
            requestType: "KEYWORD_RESEARCH",
            requestData: '{"keywordCount":12,"avgDifficulty":42,"topKeyword":"plumber austin tx"}',
            status: ApprovalStatus.PENDING,
            requestedById: coordinator.id,
        ...
        },
        {
            ...
            description: "GBP profile for Coastal Bites has been suspended. Prepared response plan including documentation of business legitimacy and request for reinstatement.",
            requestType: "SUSPENSION_RESPONSE",
            requestData: '{"suspensionReason":"疑似虚假评论","responseStrategy":"提交营业执照 + 税务证明 + 5条真实客户证词"}',
            status: ApprovalStatus.PENDING,
            requestedById: owner.id,
        ...
        },
        {
            ...
            description: "Requesting change from 'Cleaning Service' to 'Janitorial Service' to better match search intent data showing 3x more searches for janitorial terms.",
            requestType: "CATEGORY_CHANGE",
            requestData: '{"current":"Cleaning Service","proposed":"Janitorial Service","reason":"Search volume 3x higher"}',
        ...
        },
        {
            ...
            description: "Monthly post for PeakFit Gym: 'New Year, New You — 20% off 3-month personal training packages. Limited spots available!'",
            requestType: "POST_PUBLISH",
            requestData: '{"postType":"OFFER","title":"New Year Special","cta":"Book Now"}',
            status: ApprovalStatus.REJECTED,
            requestedById: coordinator.id,
            approvedById: approver.id,
            rejectedReason: "Post contains promotional pricing that hasn't been verified by the business owner. Please confirm rates before resubmitting.",
    ...
    const reqData = [
        ...
        },
        {
            ...
            sprint: 0,
            status: ReqStatus.DONE,
            note: "Evidence: [Build Status screen](/), [Build Status API](/api/build-status). Requirement evidence is checked by the consolidated CI gate.",
        },
        {
            reqId: "REQ-NFR-04",
            ...
            sprint: 0,
            status: ReqStatus.IN_PROGRESS,
            blockedBy: "Viewport, accessibility, bundle, and Lighthouse gates pending",
        },
        // Sprint 1
        {
            reqId: "REQ-M6-01",
        ...
        },
        {
            ...
            sprint: 1,
            status: ReqStatus.IN_PROGRESS,
            blockedBy: "Numeric shared priority classifier and dependency ordering pending",
        },
        {
            reqId: "REQ-M6-04",
        ...
        },
        {
            ...
            sprint: 2,
            status: ReqStatus.IN_PROGRESS,
            blockedBy: "Service-name normalization and end-to-end callback tests pending",
        },
        {
            reqId: "REQ-M1-03",
        ...
        },
        {
            ...
            sprint: 5,
            status: ReqStatus.IN_PROGRESS,
            blockedBy: "Immutable storage exists; full baseline capture workflow pending",
        },
        {
            reqId: "REQ-M5-03",
            ...
            sprint: 6,
            status: ReqStatus.IN_PROGRESS,
            blockedBy: "Scheduled notification-backed anomaly rules exist; simulated-data behavioral tests pending",
        },
        {
            reqId: "REQ-M5-04",
            ...
            sprint: 6,
            status: ReqStatus.IN_PROGRESS,
            blockedBy: "Report lineage and PDF sections exist; archive, portal HTML, and access-control proof pending",
        },
        {
            reqId: "REQ-M5-05",
            ...
            sprint: 6,
            status: ReqStatus.IN_PROGRESS,
            blockedBy: "Diagnosis task generation and checklist order exist; full behavioral tests pending",
        },
        // Scope
        {
            reqId: "REQ-SCOPE-01",
