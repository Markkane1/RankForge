...
_Generated 2026-07-18 — re-run `npx codesight --wiki` if the codebase has changed._
...
- [Brightlocal.controller](./brightlocal.controller.md)
- [Dataforseo.controller](./dataforseo.controller.md)
- [Localfalcon.controller](./localfalcon.controller.md)
- [Route](./route.md)
- [Tasks.controller](./tasks.controller.md)
- [Use-realtime-events](./use-realtime-events.md)
- [Infra](./infra.md)
- [Ui](./ui.md)
...
- Models: **45**
- Components: **23**
- Env vars: **22** required, **9** with defaults
...
---
_Last compiled: 2026-07-18 · 14 articles · [codesight](https://github.com/Houseofmvps/codesight)_