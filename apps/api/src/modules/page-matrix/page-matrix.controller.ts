...
export class PageMatrixController {
  ...
  @ApiResponse({ status: 201, description: 'Page matrix entry created successfully' })
  ...
  @ApiResponse({ status: 200, description: 'List of page matrix entries returned successfully' })
  @Get()
  ...
  @ApiResponse({ status: 400, description: 'Validation or template checks failed' })
  @Put(':entryId')
  async updateEntry(
    @Param('id') clientId: string,
  ...
  @ApiResponse({ status: 201, description: 'Conversion event logged successfully' })
  ...
  @ApiResponse({ status: 200, description: 'Page matrix entry deleted successfully' })
  @Delete(':entryId')
