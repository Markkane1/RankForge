...
export class ContentPipelineController {
  ...
  async updateScheduledPost(
    ...
    return this.contentPipelineService.updateScheduledPost(
      clientId,
      postId,
      body,
    );
  ...
  @ApiOperation({
    summary: 'Generate content draft draft using LLM model rules',
  })
  @ApiResponse({
    status: 200,
    description: 'AI content draft generated successfully',
  })
  @Post('posts/generate')
  ...
  @ApiResponse({
    status: 200,
    description: 'Search visibility tracking information',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Scanned posts and flagged stale ones',
  })
  @Post('stale-scan')
